...
| Process analytics | DAC/HTSE/Methanol closures | Analytic closure error | `<= 1e-9` for reference checks | `/Users/stefioannidis/Documents/UCL/Y2/RR/copies/Corrected_Approach/sco2_plant/run_tests.py` strict gates |
| Boundary consistency | Accounting-mode switch | Distinct FoM structure and values | Must differ and stay mode-tagged | `/Users/stefioannidis/Documents/UCL/Y2/RR/copies/Corrected_Approach/sco2_plant/run_tests.py` strict gates |
| Secondary cycle anchor | Alternate operating point | Thermal efficiency band check | `0.30 <= eta_thermal <= 0.55` and converged | `/Users/stefioannidis/Documents/UCL/Y2/RR/copies/Corrected_Approach/sco2_plant/run_tests.py` strict gates |
...
3. `S0_BASE_30MW_OPONLY` (boundary sensitivity)
4. `S1_36MW_OPONLY` (boundary + power sensitivity)
...
1. External benchmark anchors are still sparse versus full subsystem-by-subsystem validation.
